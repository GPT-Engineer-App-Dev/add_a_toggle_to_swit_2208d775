...
const Index = () => {
  ...
  const toggleLanguage = () => {
    ...
    if (language === "AR") {
      document.title = "فيلم هاب";
    } else {
      document.title = "Film Hub";
    }
  };
        ...
        <SimpleGrid columns={2} spacing={10}>
          <GridItem colSpan={1}>
            <Box bg="white" borderRadius="md" shadow="md" p={6}>
              ...
              <Text mb={4}>{language === "AR" ? "أنشئ ملفًا شخصيًا، وعرض مهاراتك، واحصل على توظيف للمشاريع في صناعة الأفلام." : "Create a personal profile, showcase your skills, and get hired for film projects."}</Text>
